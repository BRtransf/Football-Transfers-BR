...
''' espaço para adicionar ao df todas as variaveis necessárias'''
...
## CA
base['Pivo'] = (base['Passes/90']*base['Passes certos, %'] + base['Dribles Certos']) / base['Passes recebidos/90']



''' fim do espaço para adicionar variaveis criadas'''




posicao = float(input('Inserir o número da posição desejada (1 a 11):'))

min_min = int(input('Minutagem mínima para analisar:'))

idade_max = int(input('Idade máxima para analisar:'))

dic_posicoes = {1:['DefesaMeta','EstiloPasse','Interseções/90','Duelos aéreos ganhos, %','Passes longos certos, %'],
                2:['Dribles Certos','Cruzamentos Certos','Tendência Cruzamento','Duelos Defensivos Ganhos','Duelos Aéreos Ganhos'],
                3:['Duelos defensivos ganhos, %','Abordagem Agressiva', 'Duelos Aéreos Ganhos','Construção','Corridas progressivas/90'],
                4:['Duelos defensivos ganhos, %','Abordagem Agressiva', 'Duelos Aéreos Ganhos','Construção','Corridas progressivas/90'],
                5:['DistSobPressão','Construção','Duelos Aéreos Ganhos','Duelos Defensivos Ganhos','Interseções/90'],
                6:['Dribles Certos','Cruzamentos Certos','Tendência Cruzamento','Duelos Defensivos Ganhos','Duelos Aéreos Ganhos'],
                7:['GolxG','Finalização','Cruzamento Efetivo','Dribles Certos','Infiltração xG'],
                8:['Desarme Intercep','Participação','Corridas progressivas/90','DistSobPressão','Infiltração Finalização'],
                8.5:['DistSobPressão','Corridas progressivas/90','Infiltração xG','Dribles Certos','Passes recebidos/90'],
                9:['GolxG','Finalização','Duelos Aéreos Ganhos','Toques na área/90','Pivo'],
                9.5:['GolxG','Finalização','Assistência','Associação','Duelos defensivos/90'],
                10:['DistSobPressão','Passes chave/90','Corridas progressivas/90','Dribles Certos','Associação'],
                11:['GolxG','Finalização','Cruzamento Efetivo','Dribles Certos','Infiltração xG']}
...
club_icon = Image.open('cruzeiro.png')
